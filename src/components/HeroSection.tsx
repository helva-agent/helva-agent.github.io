        ...
        >
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                >
                    <FrostButton
                        variant="primary"
                        className="w-full h-[52px] text-sm font-medium hover:scale-105 transition-all duration-300 shadow-2xl"
                        showIcon={false}
                        style={{
...
const HelvaModel = ({
    ...
    return (
        <div className="lg:col-span-4 flex items-center justify-center relative">
            ...
            >
                <div className={" bg-black relative overflow-hidden w-full h-full"}> {/* Added h-full here */}
                    <video
                    ...
                    />
                    {/* Il div maschera con il gradiente radiale */}
                    <div
                        className="absolute inset-0 pointer-events-none"
                        style={{
                            background:
                                "radial-gradient(circle at center, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 70%)",
                        }}
                    ></div>
                </div>
            </div>
...
const ScrollIndicator = () => (
    <div
        className="absolute bottom-0 left-1/2 transform -translate-x-1/2 animate-bounce z-0 hidden lg:block"
